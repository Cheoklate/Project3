...
/* harmony export */   "default": () => (/* binding */ initHackyController)
/* harmony export */ });
...
/* harmony import */ var _styles_scss__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./styles.scss */ "./src/styles.scss");
...
loginBtn.addEventListener('click', function () {
  axios__WEBPACK_IMPORTED_MODULE_17__.post('/login', {
...
logoutBtn.addEventListener('click', function () {
  axios__WEBPACK_IMPORTED_MODULE_17__.put("/logout/".concat(currentGame.id)).then(function (response) {
...
function initHackyController(db) {
  var move = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
      var boardState, _currentGame, updatedGame;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return db.Game.findByPk(req.params.id);

            case 5:
              _currentGame = _context.sent;
              _context.next = 8;
              return _currentGame.update({
                gameState: {
                  status: 'active',
                  boardState: saveJSON()
                }
...
startGameBtn.addEventListener('click', function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_17__.get('/start').then(function (response) {
        ...
        try {
          for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
            ...
            _cell3.addEventListener('click', function () {
              axios__WEBPACK_IMPORTED_MODULE_17__.put("./move/".concat(currentGame.id)).then(function (response1) {
...
refreshBtn.addEventListener('click', function () {
  axios__WEBPACK_IMPORTED_MODULE_17__.post('/refresh', {
    id: currentGame.id
  }).then(function (response) {
    console.log(response);
  }).catch(function (error) {
